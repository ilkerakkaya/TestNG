...
public class SoftAssertTest {
    ...
    public void hardAssertTest(){
        ...
        WebElement imagesLink=driver.findElement(By.linkText("Afbeeldingen"));
        //Assert if the images link text is equal to "Images"
        String actualImageLinkText=imagesLink.getText();
        String expectedImageLinkText="Afbeeldingen";
        Assert.assertEquals(actualImageLinkText,expectedImageLinkText);//PASS
        WebElement singInLink=driver.findElement(By.linkText("Inloggen"));
        //Assert if the sign in link text "sign in"
        String expectedSignInLinkText="Inloggen";
